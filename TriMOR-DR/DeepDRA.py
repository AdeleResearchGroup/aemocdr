...
def train(model, train_loader, val_loader, num_epochs, class_weight):
    """
...
def test(model, test_loader, reverse=False, show_plot=False):
    """
    ...
    result = Evaluation.evaluate(labels, predictions, show_plot=show_plot)
